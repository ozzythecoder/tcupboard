...
import ShowFormMinimal from './ShowFormMinimal';

const EditShowPageMinimal = () => {
  const { id } = useParams();
  ...
  return <ShowFormMinimal isEdit={true} initialData={show} />;
};

export default EditShowPageMinimal;