    ...
    apps: [
        {
            ...
            env: {
                ...
                APP_ENV: "production",
                DOTENV_CONFIG_PATH:
                    "/var/www/tcup-production/backend/.env.production",
                PORT: 3002,
            },
        ...
        },
        {
            ...
            env: {
                ...
                APP_ENV: "staging",
                DOTENV_CONFIG_PATH:
                    "/var/www/tcup-staging/backend/.env.staging", // Changed to .env.staging
                PORT: 3004,
            },
            max_memory_restart: "500M",
        ...
        },
        {
            ...
            max_memory_restart: "500M",
            error_file: "/var/log/pm2/tcup-backend-dev-error.log",
            out_file: "/var/log/pm2/tcup-backend-dev-out.log",
            log_date_format: "YYYY-MM-DD HH:mm:ss",
        },
    ],
};
