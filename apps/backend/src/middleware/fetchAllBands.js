            ...
            return {
                ...
                profile_image:
                    typeof formattedBand.profile_image === "string"
                        ...
                        : null,
                social_links:
                    Array.isArray(formattedBand.social_links) &&
                    formattedBand.social_links.length > 0
                        ? formattedBand.social_links
                        : [],
                genre: Array.isArray(formattedBand.genre) ? formattedBand.genre : [],
                other_images: Array.isArray(formattedBand.other_images)
                    ? formattedBand.other_images
                    : [],
            };
        });
