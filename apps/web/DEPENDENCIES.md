...
1. [x] Remove accidental packages (`-`, `save`)
2. [x] Remove completely unused packages (10 packages with 0 imports)
3. [x] Finish CRA-to-Vite migration (remove `react-scripts` + CRA artifacts)
4. [x] Remove server-side packages (`express`, `pg`, `cloudinary`, `auth0`, etc.)
